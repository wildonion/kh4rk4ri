...
preprocessed        = Preprocessor(paths=[train_path]) # NOTE - preprocessed() will return the self
training_dataloader = DataLoader(preprocessed=preprocessed, transformer=preprocessed.Transformer)
